                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="name" placeholder="打印机名称模糊查询" class="layui-input" />
                        </div>
                    </div>
...
@section('listscript')
    <script type="text/javascript">
        layui.use(['form','table','laydate', 'treetable'], function(){
            ...
            table.render({
                elem: '#tableList',
                url: '/admin/small_ticket/ajaxList',
                ...
                cols: [[
                    ...
                    {field: 'brand', title: '打印机品牌',
                        templet: function (info){
                            if(info.url == "") return info.brand;
                            return '<a style="color: #00a0e9" href="'+info.url+'" target="_blank" title="'+info.brand+'">'+info.brand+'</a>'
                        }
                    },
                ...
                switch(obj.event){
                    case "add": // 新增
                        var index = layer.open({
                            ...
                            shadeClose: true,
                            area: ['80%', '80%'],
                            content: '/admin/small_ticket/edit',
                        });
                        break;
                ...
                switch (obj.event){
                    case "edit":  // 编辑功能
                        var index = layer.open({
                            ...
                            shadeClose: true,
                            area: ['80%', '80%'],
                            content: '/admin/small_ticket/edit?id='+id,
                        });
                        break;
                    case "del":  // 删除功能
                        layer.confirm('确定删除 ' + data.name + ' 打印机吗？', {
                            title : "删除打印机",
                            skin: 'layui-layer-lan'
                        },function(index){
                            $.ajax({
                                url:'/admin/small_ticket/del',
                                type:'post',
                                data:{'id':id},
                                dataType:"JSON",
